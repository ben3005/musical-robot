...
namespace musical_robot.Services
{
	...
	{
		public string Key { get { return "sigwlFxaiHclPH33RjvfA8j7A"; } }
		public string Secret { get { return "qEGW3GTaiueeR0jmTnfd1NvtCsieRQBjpXeX86rUWisKsfo0RC"; } }
		...
		private string GetHashTagsQueryParams(params string[] hashtags)
		{
			...
			var result = string.Join(
				...
				string.Join(" ", hashtags)
					...
					.Select(e => System.Net.WebUtility.UrlEncode(string.Concat("#", e.Replace("#", string.Empty))))
					.ToArray()
				);
